...
- 커밋: `725cf16` (`build(web): refresh canary release bootstrap`), `origin/hotfix` 반영. 화면 소스는 직전 `dae6969` HTML 리팩터링 커밋을 포함한다.
- Vercel: [`dpl_2UwyE4zfj49TncDYDqaDNWfi663a`](https://vercel.com/cw20208021-9200s-projects/aiflow-web-canary/2UwyE4zfj49TncDYDqaDNWfi663a), production alias [`aiflow-web-canary.vercel.app`](https://aiflow-web-canary.vercel.app/#/student/dashboard).
